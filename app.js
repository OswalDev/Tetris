document.addEventListener('DOMContentLoaded', () => {
    ...
    let nextRandom = 0
    const colors = [
      'url(css/images/blue_block.png)',
      'url(css/images/pink_block.png)',
      'url(css/images/purple_block.png)',
      'url(css/images/peach_block.png)',
      'url(css/images/yellow_block.png)'
    ]
